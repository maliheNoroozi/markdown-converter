...
>(({ markdown }, ref) => {
  ...
  return (
    <div className="flex-grow overflow-auto p-4 bg-gray-100 rounded-md relative">
      <Button
        size="icon"
        variant="ghost"
        onClick={prevSlide}
        disabled={currentSlide === 0}
        className="cursor-pointer absolute left-2 top-1/2"
      >
      ...
      <div
        ...
        className="prose max-w-none px-8 py-2"
      />
    </div>
  );
});
